"""
Django settings for fundraisee project.
...
SECRET_KEY = '@m7=ju*zp$vyk8avttt5-nw=7ocmxuhhl=del4qz3w!*3l_gj4'
...
WSGI_APPLICATION = 'fundraisee.wsgi.application'
